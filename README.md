...
### Es necesario ejecutar estas lineas de comando, ya que esto instala "express" para el servidor, "sqlite3" para interactuar con la base de datos y "body-parser" para procesar datos en las solicitudes POST

![image](https://github.com/user-attachments/assets/98e9f993-2311-4d49-9771-761cbcc867bd)

![image](https://github.com/user-attachments/assets/f248d59d-b879-4fb9-b6c0-851e9ee55475)

### Una vez realizado esto, solamente queda utilizar el boton de la herramienta Live Server para ejecutar el programa
![image](https://github.com/user-attachments/assets/531bbeb6-e5da-4a40-a97c-de329046f22f)

### Esto abrirá una pestaña de su navegador con la aplicacion lista para usar
![image](https://github.com/user-attachments/assets/e3fd1d87-6ccd-45c6-bc1f-a819a4e70434)
